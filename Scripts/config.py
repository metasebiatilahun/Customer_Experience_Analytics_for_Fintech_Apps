...
# env
    ...
    'BOA': os.getenv('BOA_APP_ID', 'com.boa.boaMobileBanking&hl=en'),
    'DashenBank': os.getenv('DashenBank_APP_ID', 'com.dashen.dashensuperapp&hl=en')
...
SCRAPING_CONFIG = {
    'reviews_per_bank': int(os.getenv('REVIEWS_PER_BANK', 4000)),
